...
Evo<sup>2</sup>Sim is a multi-scale model of <em>in silico</em> experimental evolution. The software is equipped with the whole tool case of experimental setups, competition assays, phylogenetic analysis, and, most importantly, allowing for evolvable ecological interactions.
